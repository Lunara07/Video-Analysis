...
#if (vid==1):
    #writer= cv2.VideoWriter('C:/Users/35841/Desktop/Masters/video analysis/result_video_1.avi', cv2.VideoWriter_fourcc(*'MJPG'), 50, (1302,height))
#else:
    #writer= cv2.VideoWriter('C:/Users/35841/Desktop/Masters/video analysis/result_video_2.avi', cv2.VideoWriter_fourcc(*'MJPG'), 25, (1102,height))
